defmodule Rumbl.UserTest do
  ...
  test "registration_changeset password must be at least 6 digits long" do
  ...
  test "registration_changeset with valid attributes hases password" do
    attrs = Map.put(@valid_attrs, :password, "superstrong1")
    changeset = User.registration_changeset(%User{}, attrs)
