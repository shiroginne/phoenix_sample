defmodule Rumbl.VideoChannel do
  ...
  def handle_in("new_annotation", params, user, socket) do
    changeset =
      user
      |> build_assoc(:annotations, video_id: String.to_integer(socket.assigns.video_id)) # hack. why?
  ...
  defp broadcast_annotation(socket, annotation) do
    ...
    renderd_ann = Phoenix.View.render(AnnotationView, "annotation.json", %{annotation: annotation})
    broadcast! socket, "new_annotation", renderd_ann
  end
